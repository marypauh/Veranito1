 ...
 * @author Raquel Rojas
 */
public class AgregarRecursosSala extends javax.swing.JFrame {

    /**
     * Creates new form AgregarRecursosSala
     */
    public AgregarRecursosSala() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarRecursosSala.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgregarRecursosSala().setVisible(true);
            }
        });
    }
